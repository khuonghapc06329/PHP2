<body id="page-top">
    ...
    use App\Controllers\ForgotPassController;
            ...
            <div class="container">
                <div class="row gx-lg-5 align-items-center">
                    <div class="col-lg-6 mb-5 mb-lg-0">
                        ...
                        <a href="<?= ROOT_URL ?>?url=RegisterController/index"><button style="background-color: #F3285F; color: #fff" class="btn">Đăng ký ngay</button></a>
                    </div>
                    ...
                    <div class="col-lg-6 mb-5 mb-lg-0">
                        <div class="">
                            <div class="box-shadow-full py-5 px-md-5">
                                ...
                                <form action="<?= ROOT_URL ?>?url=ForgotPassController/index" method="post">
                                    <?php


                                    if (isset($_POST['submit'])) {
                                        $forgotpass = new ForgotPassController();
                                        $forgotpass->checkForgotPassword();
                                    }
                                    ?>
                                    <!-- Password input -->
                                    <div class="form-outline mb-4">
                                        <label style="float: left;" class="form-label" for="form3Example4">Nhập địa chỉ
                                            email</label>
                                        <input type="email" name="email" id="form3Example4" class="form-control" />
    ...
    <section class="paralax-mf footer-paralax bg-image sect-mt4 route" style="background-image: url(./Public/Accests/Client/img/fpt-6.jpg)">
        <div class="overlay-mf"></div>
        <?php
