                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <li class="main-nav-list"><a data-toggle="collapse" href="#officeProduct"
                                        ...
                                        <div class="avarta"><img src="../public/accests/admin/img/avatar-3.png" alt=""
                            ...
                            <div class="mb-3">
                                <li class="main-nav-list"><a data-toggle="collapse" href="#officeProduct"
                                        aria-expanded="false" aria-controls="officeProduct"><span
                                            ...
                                            style="color: black;">Huỳnh An Khương</span></a></li>
                            </div>
                            <div class="mb-3">
                                <li class="main-nav-list"><a data-toggle="collapse" href="#officeProduct"
                                        aria-expanded="false" aria-controls="officeProduct"><span
                                            class="lnr lnr-arrow-right"></span>Địa chỉ: <span class="number"
                                            style="color: black;">Cái Răng - Cần thơ</span></a></li>
                            </div>
                            <div class="mb-3">
                                <li class="main-nav-list"><a data-toggle="collapse" href="#officeProduct"
                                        aria-expanded="false" aria-controls="officeProduct"><span
                                            class="lnr lnr-arrow-right"></span>Điện thoại: <span class="number"
                                            style="color: black;">0813767025</span></a></li>
                            </div>
                            <div class="mb-3">
                                <li class="main-nav-list"><a data-toggle="collapse" href="#officeProduct"
                                        aria-expanded="false" aria-controls="officeProduct"><span
                                            class="lnr lnr-arrow-right"></span>Email: <span class="number"
                                            style="color: black;">khuonghapc06329@fpt.edu.vn</span></a>
                                </li>
                            </div>
                            ...
                            <div class="mb-3">
                                <li class="main-nav-list"><a data-toggle="collapse" href="#officeProduct"
                                        aria-expanded="false" aria-controls="officeProduct"><span
                                            ...
                                            style="color: black;">Quản trị viên</span></a></li>
                            </div>


                            <div class="mb-3">
                                <li class="main-nav-list" style="margin-bottom: 2%">
                                    <a style="text-decoration: none;" href="index.php?act=update-admin">
                                        <button class="btn btn-primary btn-block confirm-button">Cập nhật thông
                                            tin</button>
                                    </a>
                                </li>
                                <li class="main-nav-list">
                                    <a style="text-decoration: none;" href="index.php?act=logout">
