...
<nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top" id="mainNav">
    <div class="container">
        <a class="navbar-brand js-scroll" href="#page-top"><img style="width: 70px" src="./public/accests/client/img/logo_dev.png" alt=""></a>
        ...
        <div class="navbar-collapse collapse justify-content-end" id="navbarDefault">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link js-scroll" href="#about">Giới thiệu</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link js-scroll" href="#service">Công việc</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link js-scroll" href="#blog">Bài viết</a>
                </li>
                <li class="nav-item">
